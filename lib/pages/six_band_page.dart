...
class _SixBandPageState extends State<SixBandPage> {
  ...
  String valuePPM = "100 PPM";
  String result = "";

  //Variable para controlar el desplazamiento de la página
  ...
  String calculateResistance() {
    ...
    if (value == value.toInt()) {
      return "${value.toInt()} $suffix $valueTolerance $valuePPM"; // Sin decimales
    } else {
      return "${value.toStringAsPrecision(3)} $suffix $valueTolerance $valuePPM";
    }
  }
  ...
  Color getPPMColor(String value) {
    switch (value) {
      case "100 PPM":
        return Color(0xFF8B4513);
      case "50 PPM":
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      //Se realiza el desplazamiento automatico para mostrar el resultado
